...
//     newvalue.push(products[i].title)
//   }
//   console.log(newvalue.join(" title "));
...
// const data = info.toExponential();
// const data = info.toFixed();


// const result = Math.floor(info)
// const result = Math.ceil(info);
const result = Math.random() * info;
...
// const info = "JAvaScriptAva";
// console.log(info.match(/ava/ig));
// const newInfo = info.match(/a/gi);
// const newInfo = info.repeat(100);
// const newInfo = info.search(/s/i);
// const newInfo = info.length;
// console.log(eval("newInfo"));
// console.log(eval('info'));
// const pass = '123';
// const myInput = document.querySelector('input');
// const a = ()=>{
//     if (pass === myInput.value.trim()) {
//         console.log('success');
//     }else{
//         console.log('wrong');
//     }
